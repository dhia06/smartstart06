...
class ProjetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $projets = $em->getRepository('MainBundle:Projet')->findAll();
    ...
    {
        $projet = new Projet();
        $form = $this->createForm('MainBundle\Form\ProjetType', $projet);
    ...
    {
        $deleteForm = $this->createDeleteForm($projet);
        $editForm = $this->createForm('MainBundle\Form\ProjetType', $projet);
