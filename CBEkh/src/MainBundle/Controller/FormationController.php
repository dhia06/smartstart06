...
class FormationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $formations = $em->getRepository('MainBundle:Formation')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MainBundle\Form\FormationType', $formation);
    ...
    {
        $deleteForm = $this->createDeleteForm($formation);
        $editForm = $this->createForm('MainBundle\Form\FormationType', $formation);
